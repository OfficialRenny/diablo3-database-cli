...
// @param opts - Options, may have following keys:
//    cid - Class ID.
//    active - true=active skills, false=passive skills.
d3client.getSkills = function(opts, cb) {
  var url = opts.active ? config.SKILLS.ACTIVE : config.SKILLS.PASSIVE;
  url = url.replace('$id', opts.cid);
...
d3client.getSkill = function(opts, cb) {
};
